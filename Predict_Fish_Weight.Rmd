...
The only variables that only make a difference in this case is the p-value. So the only significant coefficient that determines the fish weight is the height where the p-value is 0.0333 less than 0.05
